...
mixin _$EnumActivityState {
  ActivityStaus get status => throw _privateConstructorUsedError;
...
abstract class $EnumActivityStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ActivityStaus status, Activity activity, String error});
